...
public interface RestClientCelcoin {
    ...
    ConsultResponseDTO consult(@HeaderParam("Authorization") String token, ConsultarBoletoDTO Dto);

    @POST
    @Path("/v5/transactions/billpayments")
    PaymentResponseDTO payment(@HeaderParam("Authorization") String token, ConsultarBoletoDTO Dto);
}
